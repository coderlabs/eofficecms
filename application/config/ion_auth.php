 ...
 */
$config['site_title']           = "Sakola.net"; 		// Site Title, example.com
$config['admin_email']          = "taufiksu@gmail.com"; 	// Admin Email, admin@example.com
$config['default_group']        = 'Karyawan'; 			// Default group, use name
